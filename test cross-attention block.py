...
attention = Attention(dim=512, num_heads=4, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., sr_ratio=2)
x = attention.forward(x=torch.randn(8,5*28*28,512), H = 28, W = 28)
print(x.shape)